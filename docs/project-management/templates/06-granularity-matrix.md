...
| **Is this a single user action or goal?** | **STORY** | This is the right level | A story has one verb: "add expense," not "manage expenses." |
...
| **Story** | "What can a user do?" | Single user goal/action | *Not decomposed further* | Card with AC | "As a member, I want to snap a receipt photo so that…" |
...
3. **Vision changes slowly.** If your vision changes every sprint, it's not a vision — it's a strategy or a feature list.

4. **Every artifact traces upward.** A story answers "which epic?" An epic answers "which roadmap theme?" A roadmap theme answers "which vision pillar?" If the chain breaks, the work is orphaned.
...
| Epic | `docs/rules/project-management/03-epics.md` | `templates/03-epic-template.md` | `docs/project-management/XX-epic-name.md` |
| Story | `docs/rules/project-management/04-userstory.md` | `templates/04-userstory-template.md` | `docs/project-management/XX-story-name.md` |
